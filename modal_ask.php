<div class="modal fade" id="secondModal" tabindex="-1">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content container-modal">
      ...
      <div class="modal-body pb-4" style="padding: 0 36px">
        <h2 class="text-center title color-blue">Оставить заявку</h2>
        <input type="text" style="margin-top: 35px" placeholder="Имя" class="form-control fs-5 modal-text mb-4" aria-describedby="inputGroup-sizing-lg">
        <input type="text" placeholder="Адрес электронной почты" class="form-control fs-5 modal-text mb-4" aria-describedby="inputGroup-sizing-lg">
        <input type="text" placeholder="Вопрос" class="form-control fs-5 modal-text mb-4" aria-describedby="inputGroup-sizing-lg">
      </div>
      <div class="modal-footer border-0 m-0" style="padding: 0 32px;">
        <button type="button" class="btn w-100 header-btn text-white fs-5 height-75" data-bs-dismiss="modal" style="margin-bottom: 60px">Отправить</button>
      </div>
    </div>
  </div>
</div>